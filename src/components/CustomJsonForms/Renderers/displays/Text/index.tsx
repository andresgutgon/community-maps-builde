...
const Text = ({ data, type }: TextDisplayProps) => {
  ...
  return (
    <div
      className={cn('prose-sm', {
        'border py-1 px-2 rounded bg-yellow-50 border-yellow-200 prose-yellow':
...
export const WarningDisplay = withJsonFormsControlProps(
  (props: ControlProps) => <Text {...props} type={TextDisplayType.warning} />
)
