...
type FakeResponse = {
  status: number
  submitResponse: { message?: null | string }
}
const formSubmit = async (
  ...
  const serverResponse: FakeResponse =
    request.method === 'POST'
      ? schrodingerSuccess
        ? {
            status: 200,
            submitResponse: { message: 'Hemos recibido tu solicitud. Gracias!' }
          }
        : {
            status: 422,
            submitResponse: { message: 'Hubo un error en el servidor' }
          }
